...
function getThemes($path, $default)
{
	...
	if (is_dir($path))
	{
		if ($fp = opendir($path)) 
		{
			...
			{
				if ((!preg_match("/^_/i",$module)) && (!preg_match("/^CVS$/i",$module)) && (!preg_match("/^css$/i",$module)) && (!preg_match("/^js$/i",$module)) && (!preg_match("/^img$/i",$module)) && (!preg_match("/^plugin$/i",$module)) && (!preg_match("/.php$/i",$module)) && (!preg_match("/.html$/i",$module)) && (!preg_match("/.DS_Store/i",$module)) && (!preg_match("/\./i",$module)) && (!preg_match("/system/i",$module)))
				{      
					$modules[] = $module;
				}
			} 
